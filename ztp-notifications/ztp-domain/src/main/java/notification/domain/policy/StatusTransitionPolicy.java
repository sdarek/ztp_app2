package notification.domain.policy;
...
public class StatusTransitionPolicy {
    private static final Map<NotificationStatus, Set<NotificationStatus>> ALLOWED_TRANSITIONS =
            Map.of(
                    ...
                    EnumSet.of(NotificationStatus.SCHEDULED, NotificationStatus.CANCELED),

                    NotificationStatus.SCHEDULED,
                    EnumSet.of(NotificationStatus.SENDING, NotificationStatus.CANCELED),

                    NotificationStatus.SENDING,
                    EnumSet.of(NotificationStatus.SENT, NotificationStatus.FAILED),

                    NotificationStatus.FAILED,
                    EnumSet.noneOf(NotificationStatus.class),
